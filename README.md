...
> **IMPORTANT:** This README is for the v5.0.0.pre.2 pre-release. For the latest stable version, see the [v4.9.0 README](https://github.com/hakanensari/peddler/blob/v4.9.0/README.md).
