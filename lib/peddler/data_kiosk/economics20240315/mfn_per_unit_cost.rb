  ...
  module DataKiosk
    module Economics20240315
      ...
      MfnPerUnitCost = Structure.new do
        # @return [Amount] Cost of fulfilling an order containing the product, including labor, packing
        ...
        # @return [Amount] Cost to store a single unit of the product per month. This value is provided
        # by the seller and applicable to Merchant Fulfilled Network (MFN) products.
