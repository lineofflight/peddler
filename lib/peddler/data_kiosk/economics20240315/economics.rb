  ...
  module DataKiosk
    module Economics20240315
      ...
      Economics = Structure.new do
        ...
        # @return [String] The Amazon Standard Identification Number of the child product. Child products
        ...
        # @return [PerUnitCost] The off Amazon cost provided by the seller for this product (per unit). The
        ...
        attribute?(:fees, [FeeSummary])

        # @return [String] The Fulfillment Network Stock Keeping Unit (FNSKU) of the product. Note: This
        ...
        # @return [String] The Merchant Stock Keeping Unit (MSKU) of the product. Note: This field is
        ...
        # @return [NetProceeds] The net proceeds for this product within the specified date range. The value
        # remains unchanged regardless of whether sales, fees, ads, or cost are selected in the query.
        attribute?(:net_proceeds, NetProceeds, from: "netProceeds")

        # @return [String] The Amazon Standard Identification Number of the parent product. A parent
