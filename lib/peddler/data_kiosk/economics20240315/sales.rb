  ...
  module DataKiosk
    module Economics20240315
      ...
      Sales = Structure.new do
        ...
        attribute?(:net_product_sales, Amount, null: false, from: "netProductSales")

        # @return [String] The number of net units sold for the selected time period, calculated by unitsOrdered -
        #   unitsRefunded.
        attribute?(:net_units_sold, String, null: false, from: "netUnitsSold")
        ...
        #   request time.
        attribute?(:refunded_product_sales, Amount, null: false, from: "refundedProductSales")
