  ...
  module DataKiosk
    module VendorAnalytics20240930
      ...
      CustomerReviewTopics = Structure.new do
        ...
        # Browse node metrics include each topic's impact value for both the overall browse node and the top 25% of
        #   products within it.
        ...
        #   months.
        # Browse node metrics include the occurrence percentage at both the overall browse node level and among the top
        #   25% of products within the browse node, for each of the past six months.
        attribute?(:negative_review_topic_trends, String, from: "negativeReviewTopicTrends")

        # @return [String] The ten most common negative topics based on customer reviews. For each topic, the top three
        #   associated snippets are provided verbatim. Additionally, the top five subtopics for each topic and the top
        #   three verbatim quotes are provided.
        ...
        #   months.
        # Browse node metrics show the occurrence percentage at both the overall browse node level and among the top 25%
        #   of products within the browse node, for each of the past six months.
        attribute?(:positive_review_topic_trends, String, from: "positiveReviewTopicTrends")

        # @return [String] The ten most common positive topics based on customer reviews. For each topic, the top three
        #   associated snippets are provided verbatim. Additionally, the top five subtopics are included for each topic,
        #   along with the top three verbatim quotes.
        # ASIN metrics include the number of mentions and occurrence percentage of each topic or subtopic.
        # Browse node metrics include the occurrence percentage of the topic or subtopic at the overall browse node
        #   level.
