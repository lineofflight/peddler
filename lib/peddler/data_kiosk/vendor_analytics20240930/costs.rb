  ...
  module DataKiosk
    module VendorAnalytics20240930
      ...
      Costs = Structure.new do
        # @return [Amount] The average selling discount per unit of shipped items. The average sales
        ...
        # @return [Amount] The total Contra Cost of Goods Sold (COGS), equal to the dollars realized by
        # customer outbound shipments minus Display Ads Contra COGS.
        attribute?(:contra_cogs, Amount, from: "contraCogs")

        # @return [Amount] The average Vendor Funded Contra-COGS (VFCC) of shipped items. Contra-COGS per
        # unit is equal to Contra-COGS divided by the shipped quantity.
        attribute?(:contra_cogs_per_unit, Amount, from: "contraCogsPerUnit")

        # @return [Float] Net Pure Product Margin (PPM) is defined as Amazon's margin after taking into
        ...
        # @return [Amount] Sales Discount is a transactional component of CP (Contribution Profit Amount)
        ...
        # @return [Amount] The shipped cost of goods sold (COGS), which is the price Amazon paid to a
