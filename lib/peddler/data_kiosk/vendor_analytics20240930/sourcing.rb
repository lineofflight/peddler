  ...
  module DataKiosk
    module VendorAnalytics20240930
      ...
      Sourcing = Structure.new do
        ...
        # @return [UnitsWithValue] Net number of units and their cost received by Amazon after subtracting the units
        #   returned to the supplier in the selected time frame.
        ...
        # @return [Float] OOS (Out of Stock) rate on all products that are procurable. Retail Out of Stock (ROOS) = Out
        #   of Stock Glance Views on Procurable ASINs / Total Glance Views. Procurability refers to whether Amazon is
        #   able to fulfill a customer delivery promise, considering the ability of known vendors to supply the ASIN in
        ...
        # The fill rate here applies only to Procurable ASINs. Fill Rate = Net Received Units / Confirmed Units.
        attribute?(:received_fill_rate, Float, from: "receivedFillRate")

        # @return [Float] How many units Vendors confirm out of the units Amazon asks for, accounting for Procurable
        #   ASINs only. Vendor Confirmation Rate = Confirmed Units / Submitted Units.
