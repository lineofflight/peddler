  ...
  module DataKiosk
    module VendorAnalytics20240930
      ...
      ProductAvailability = Structure.new do
        # @return [UnitsWithValue] The number of units and their cost that is at least 90 days old and in
        ...
        # @return [Float] Calculated as the number of units shipped in comparison to the number of units
        ...
        # @return [Float] The sourceable replenishment out of stock percentage, which is the percentage
        ...
        # @return [Float] Ultra Fast Track (UFT), is an hourly measure of the percentage of time an ASIN
        ...
        # @return [UnitsWithValue] Excess number of units and their cost on the last day of the selected time
        ...
        # @return [UnitsWithValue] The number of units and their cost in Amazon FCs that is in unsellable
