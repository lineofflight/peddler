  ...
  module DataKiosk
    module SalesAndTraffic20240424
      SalesAndTrafficTrends = Structure.new do
        ...
        attribute?(:sales, ByASINSales)

        # @return [String] The Stock Keeping Unit of the product. The SKU is a seller specific product
        ...
        attribute?(:traffic, ByASINTraffic)
      end
    end
  end
end
