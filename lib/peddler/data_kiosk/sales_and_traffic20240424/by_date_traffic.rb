  ...
  module DataKiosk
    module SalesAndTraffic20240424
      ...
      ByDateTraffic = Structure.new do
        # @return [String] The average number of offers listed for sale in the selected time period. It
        # is calculated from the total number of offers and the total number of days in
        # the selected time period.
        attribute?(:average_offer_count, String, from: "averageOfferCount")

        # @return [String] The average number of parent items listed for sale in the selected time period.
        attribute?(:average_parent_items, String, from: "averageParentItems")
        ...
        attribute?(:feedback_received, String, from: "feedbackReceived")
        ...
        attribute?(:negative_feedback_received, String, from: "negativeFeedbackReceived")

        # @return [Float] The percentage conversion metric indicating how many order items were
        ...
        # @return [Float] The negative feedback rate is the number of orders that have received negative
