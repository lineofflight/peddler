...
module Peddler
  module APIs
    class Promotions20251201
      ...
      PromotionSummary = Structure.new do
        ...
        # @return [LatestRevision] The latest revision data, when it diverges from the published revision. Present only
        #   when an edit is still processing (`revisionStatus: PROCESSING`) or was rejected (`revisionStatus: FAILED`).
        #   Absent when the latest revision matches the published revision (stable state).
