  ...
  module APIs
    class VendorShipmentsV1
      ...
      Shipment = Structure.new do
        ...
        attribute(:transaction_date, Time, null: false, from: "transactionDate")

        # @return [String] Indicates the type of transportation request (for example, `New` or `Cancel`). Each
        #   `transactionType` has a unique set of operations and there are corresponding details to be populated for
        #   each operation.
        ...
        attribute(:vendor_shipment_identifier, String, null: false, from: "vendorShipmentIdentifier")
