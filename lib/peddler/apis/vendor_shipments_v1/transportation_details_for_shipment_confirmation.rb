  ...
  module APIs
    class VendorShipmentsV1
      ...
      TransportationDetailsForShipmentConfirmation = Structure.new do
        ...
        #   vendor or shipper during the creation of the Bill of Lading. This number must be unique for every shipment
        #   and cannot be a date/time or single character. The BOL numer is mandatory in Shipment Confirmation message
        #   for FTL and LTL shipments, and must match the paper BOL provided with the shipment. Instead of BOL, an
        #   alternative reference number (like Delivery Note Number) for the shipment can also be sent in this field.
        ...
        #   a unique two to four letter code used to identify a carrier. Carrier SCAC codes are assigned and maintained
        #   by the NMFTA (National Motor Freight Association). This field is mandatory for US, CA, MX shipment
        #   confirmations.
