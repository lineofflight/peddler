  ...
  module APIs
    class VendorShipmentsV1
      ...
      ShipmentConfirmation = Structure.new do
        ...
        attribute(:shipment_confirmation_date, Time, null: false, from: "shipmentConfirmationDate")
        ...
        attribute(:shipment_confirmation_type, String, null: false, from: "shipmentConfirmationType")

        # @return [String] Unique shipment ID (not used over the last 365 days).
        attribute(:shipment_identifier, String, null: false, from: "shipmentIdentifier")
        ...
        #   level.
        attribute(:shipped_items, [Item], null: false, from: "shippedItems")
