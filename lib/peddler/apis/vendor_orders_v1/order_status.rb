  ...
  module APIs
    class VendorOrdersV1
      ...
      OrderStatus = Structure.new do
        ...
        attribute(:item_status, [OrderItemStatus], null: false, from: "itemStatus")
        ...
        attribute(:purchase_order_status, String, null: false, from: "purchaseOrderStatus")
        ...
        attribute(:ship_to_party, PartyIdentification, null: false, from: "shipToParty")
