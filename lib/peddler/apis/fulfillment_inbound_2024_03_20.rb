...
module Peddler
  ...
  module APIs
    ...
    class FulfillmentInbound20240320 < API
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def create_inbound_plan(body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def get_inbound_plan(inbound_plan_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_inbound_plan_boxes(inbound_plan_id, page_size: 10, pagination_token: nil, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def cancel_inbound_plan(inbound_plan_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_inbound_plan_items(inbound_plan_id, page_size: 10, pagination_token: nil, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def update_inbound_plan_name(inbound_plan_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def set_packing_information(inbound_plan_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_packing_options(inbound_plan_id, page_size: 10, pagination_token: nil, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def generate_packing_options(inbound_plan_id, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans/#{inbound_plan_id}/packingOptions"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def confirm_packing_option(inbound_plan_id, packing_option_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_inbound_plan_pallets(inbound_plan_id, page_size: 10, pagination_token: nil, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_placement_options(inbound_plan_id, page_size: 10, pagination_token: nil, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def generate_placement_options(inbound_plan_id, body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans/#{inbound_plan_id}/placementOptions"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def confirm_placement_option(inbound_plan_id, placement_option_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def get_shipment(inbound_plan_id, shipment_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def generate_shipment_content_update_previews(inbound_plan_id, shipment_id, body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans/#{inbound_plan_id}/shipments/#{shipment_id}/contentUpdatePreviews"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def get_delivery_challan_document(inbound_plan_id, shipment_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def generate_delivery_window_options(inbound_plan_id, shipment_id, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans/#{inbound_plan_id}/shipments/#{shipment_id}/deliveryWindowOptions"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def update_shipment_name(inbound_plan_id, shipment_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def cancel_self_ship_appointment(inbound_plan_id, shipment_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def generate_self_ship_appointment_slots(inbound_plan_id, shipment_id, body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans/#{inbound_plan_id}/shipments/#{shipment_id}/selfShipAppointmentSlots"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def schedule_self_ship_appointment(inbound_plan_id, shipment_id, slot_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def update_shipment_source_address(inbound_plan_id, shipment_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def update_shipment_tracking_details(inbound_plan_id, shipment_id, body, rate_limit: 2.0, tries: 2)
      ...
      def list_transportation_options(inbound_plan_id, page_size: 10, pagination_token: nil, placement_option_id: nil,
        shipment_id: nil, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def generate_transportation_options(inbound_plan_id, body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/inboundPlans/#{inbound_plan_id}/transportationOptions"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def confirm_transportation_options(inbound_plan_id, body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_item_compliance_details(mskus, marketplace_id, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def update_item_compliance_details(marketplace_id, body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/items/compliance"
        params = {
          "marketplaceId" => marketplace_id,
        }.compact
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def create_marketplace_item_labels(body, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def list_prep_details(marketplace_id, mskus, rate_limit: 2.0, tries: 2)
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def set_prep_details(body, rate_limit: 2.0, tries: 2)
        path = "/inbound/fba/2024-03-20/items/prepDetails"
      ...
      # @param tries [Integer] Total request attempts, including retries
      # @return [Peddler::Response] The API response
      def get_inbound_operation_status(operation_id, rate_limit: 2.0, tries: 2)
