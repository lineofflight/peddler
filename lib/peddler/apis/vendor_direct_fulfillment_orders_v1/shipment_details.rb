  ...
  module APIs
    class VendorDirectFulfillmentOrdersV1
      ...
      ShipmentDetails = Structure.new do
        ...
        attribute(:priority_shipment, :boolean, null: false, from: "isPriorityShipment")

        # @return [:boolean] When true, a packing slip is required to be sent to the customer.
        attribute(:pslip_required, :boolean, null: false, from: "isPslipRequired")

        # @return [String] Message to customer for order status.
        attribute(:message_to_customer, String, null: false, from: "messageToCustomer")
        ...
        attribute(:ship_method, String, null: false, from: "shipMethod")

        # @return [ShipmentDates]
        attribute(:shipment_dates, ShipmentDates, null: false, from: "shipmentDates")
