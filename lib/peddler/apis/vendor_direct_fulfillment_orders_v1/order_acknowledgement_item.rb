  ...
  module APIs
    class VendorDirectFulfillmentOrdersV1
      ...
      OrderAcknowledgementItem = Structure.new do
        ...
        attribute(:acknowledgement_status, AcknowledgementStatus, null: false, from: "acknowledgementStatus")
        ...
        attribute(:vendor_order_number, String, null: false, from: "vendorOrderNumber")
      end
    end
  end
end
