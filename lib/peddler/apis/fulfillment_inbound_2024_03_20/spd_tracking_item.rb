  ...
  module APIs
    class FulfillmentInbound20240320
      ...
      SpdTrackingItem = Structure.new do
        ...
        #   asynchronous, tracking IDs might not be validated immediately, and the status might change after a few
        #   hours. If more than 24 hours have passed and the status is not yet 'VALIDATED' or `NOT_SUPPORTED`, verify
        #   the number and update it if necessary. **Possible values:** `VALIDATED`, `NOT_VALIDATED`, `NOT_SUPPORTED`
