  ...
  module APIs
    class VendorDirectFulfillmentShipping20211228
      ...
      ShipmentSchedule = Structure.new do
        ...
        #   delivered. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time
        ...
        #   [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format, with UTC time zone or
