  ...
  module APIs
    class SalesV1
      ...
      OrderMetricsInterval = Structure.new do
        ...
        attribute(:average_unit_price, Money, null: false, from: "averageUnitPrice")
