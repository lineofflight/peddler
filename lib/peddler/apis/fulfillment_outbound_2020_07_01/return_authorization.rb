  ...
  module APIs
    class FulfillmentOutbound20200701
      ...
      ReturnAuthorization = Structure.new do
        ...
        attribute(:amazon_rma_id, String, null: false, from: "amazonRmaId")
        ...
        attribute(:return_authorization_id, String, null: false, from: "returnAuthorizationId")

        # @return [Address] The address of the Amazon fulfillment center that the return items should be sent to.
        attribute(:return_to_address, Address, null: false, from: "returnToAddress")
        ...
        attribute(:rma_page_url, String, null: false, from: "rmaPageURL")
      end
    end
  end
end
