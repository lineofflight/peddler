  ...
  module Reports
    module SellerSalesAndTraffic
      ...
      TrafficByASIN = Structure.new do
        ...
        # times within a 24 hour period it is counted as a single session.
        ...
        # relative to the total number of page views by Amazon Business customers for all products. Note: This field is
        # only populated when the seller is a B2B seller.
        ...
        # Business customer visits your pages multiple times within a 24 hour period it is counted as a single session.
        # Note: This field is only populated when the seller is a B2B seller.
        ...
        # customers relative to the number of Amazon Business customers who viewed the products, calculated by dividing
        # unitsOrderedB2B by sessions. Note: This field is only populated when the seller is a B2B seller.
