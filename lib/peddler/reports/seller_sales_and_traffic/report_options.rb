  ...
  module Reports
    module SellerSalesAndTraffic
      ...
      ReportOptions = Structure.new do
        ...
        # the report. Valid values are: PARENT, CHILD, SKU. If this parameter is omitted, then the salesAndTrafficByAsin
        # section of this report will default to PARENT granularity.
