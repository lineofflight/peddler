  ...
  module Reports
    module SellerSalesAndTraffic
      ...
      SalesByDate = Structure.new do
        ...
        # difference between orders, order items, and units take the following order as an example: An order containing
        # 2 copies of book A and 3 copies of book B; The number of orders is 1, the number of order items is 2 (book A
        ...
        # orderedProductSalesB2B by totalOrderItemsB2B for the selected time period. Note: This field is only populated
        ...
        # period. For clarification on the difference between orders, order items, and units take the following order as
        # an example: An order containing 2 copies of book A and 3 copies of book B; The number of orders is 1, the
        # number of order items is 2 (book A and book B), and the number of units is 5 (2 + 3). Note: This field is only
        # populated when the seller is a B2B seller.
        ...
        # clarification on the difference between orders, order items, and units take the following order as an example:
        # An order containing 2 copies of book A and 3 copies of book B; The number of orders is 1, the number of order
        # items is 2 (book A and book B), and the number of units is 5 (2 + 3). Note: This field is only populated when
