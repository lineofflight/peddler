  ...
  module Reports
    module SellerSalesAndTraffic
      ...
      TrafficByDate = Structure.new do
        ...
        attribute(:average_offer_count, Integer, from: "averageOfferCount")

        # @return [Integer] The average number of parent items listed for sale in the selected time period.
        attribute(:average_parent_items, Integer, from: "averageParentItems")
        ...
        attribute(:feedback_received, Integer, from: "feedbackReceived")
        ...
        attribute(:negative_feedback_received, Integer, from: "negativeFeedbackReceived")
        ...
        attribute(:order_item_session_percentage, Float, from: "orderItemSessionPercentage")
        ...
        attribute(:received_negative_feedback_rate, Float, from: "receivedNegativeFeedbackRate")

        # @return [Integer] Sessions are visits to your Amazon.com pages using browser or mobile app by any user. All
        # activity within a 24-hour period is considered a session. For example, if any user visits your pages multiple
        # times using mobile app or browser within a 24 hour period it is counted as a single session.
        ...
        # Amazon.com browser pages for the selected time period. Note: This field is only populated when the seller is a
        # B2B seller.
        ...
        # shopping cart link) appeared on the page for customers to add your product to their cart. Note: This field is
        ...
        # Business customer visits your pages using mobile app multiple times within a 24 hour period it is counted as a
        # single session. Note: This field is only populated when the seller is a B2B seller.
