  ...
  module Reports
    module VendorNetPureProductMargin
      ...
      ReportSpecification = Structure.new do
        ...
        # and YEAR reportPeriods, this value must correspond to the last day in the specified reportPeriod. For example,
        ...
        # QUARTER and YEAR reportPeriods, this value must correspond to the first day in the specified reportPeriod. For
