  ...
  module Reports
    module SellingPartnerMarketBasketAnalysis
      ...
      DetailsByASIN = Structure.new do
        ...
        attribute(:combination_pct, Float, null: false, from: "combinationPct")
        ...
        #   order as the asin.
        attribute(:purchased_with_asin, String, null: false, from: "purchasedWithAsin")
        ...
        attribute(:purchased_with_rank, Integer, null: false, from: "purchasedWithRank")
