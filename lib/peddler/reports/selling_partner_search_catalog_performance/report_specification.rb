  ...
  module Reports
    module SellingPartnerSearchCatalogPerformance
      ...
      ReportSpecification = Structure.new do
        ...
        #   reportPeriods, this value must correspond to the last day in the reportPeriod that you specify or else a
        #   fatal error returns. For example, dataEndTime must be a Saturday for the WEEK reportPeriod.
