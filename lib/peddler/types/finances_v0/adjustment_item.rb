  ...
  module Types
    module FinancesV0
      ...
      AdjustmentItem = Structure.new do
        ...
        # @return [Types::Money] The per unit value of the item.
        attribute(:per_unit_amount, Types::Money, from: "PerUnitAmount")

        # @return [Types::Money] The total value of the item.
