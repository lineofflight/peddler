...
module Peddler
  class << self
    ...
    alias amazon_warehousing_and_distribution amazon_warehousing_and_distribution_2024_05_09
    alias aplus_content aplus_content_2020_11_01
    alias application_integrations application_integrations_2024_04_01
    alias application_management application_management_2023_11_30
    alias catalog_items catalog_items_2022_04_01
    alias customer_feedback customer_feedback_2024_06_01
    alias data_kiosk data_kiosk_2023_11_15
    alias delivery_by_amazon delivery_by_amazon_2022_07_01
    alias easy_ship easy_ship_2022_03_23
    alias external_fulfillment_inventory external_fulfillment_inventory_2024_09_11
    alias external_fulfillment_returns external_fulfillment_returns_2024_09_11
    alias external_fulfillment_shipments external_fulfillment_shipments_2024_09_11
    alias fba_inbound_eligibility fba_inbound_eligibility_v1
    alias fba_inventory fba_inventory_v1
    alias feeds feeds_2021_06_30
    alias finances finances_2024_06_19
    alias fulfillment_inbound fulfillment_inbound_2024_03_20
    alias fulfillment_outbound fulfillment_outbound_2020_07_01
    alias invoices invoices_2024_06_19
    alias listings_items listings_items_2021_08_01
    alias listings_restrictions listings_restrictions_2021_08_01
    alias merchant_fulfillment merchant_fulfillment_v0
    alias messaging messaging_v1
    alias notifications notifications_v1
    alias orders orders_2026_01_01
    alias product_fees product_fees_v0
    alias product_pricing product_pricing_2022_05_01
    alias product_type_definitions product_type_definitions_2020_09_01
    alias replenishment replenishment_2022_11_07
    alias reports reports_2021_06_30
    alias sales sales_v1
    alias seller_wallet seller_wallet_2024_03_01
    alias sellers sellers_v1
    alias services services_v1
    alias shipment_invoicing shipment_invoicing_v0
    alias shipping shipping_v2
    alias solicitations solicitations_v1
    alias supply_sources supply_sources_2020_07_01
    alias tokens tokens_2021_03_01
    alias transfers transfers_2024_06_01
    alias uploads uploads_2020_11_01
    alias vehicles vehicles_2024_11_01
    alias vendor_direct_fulfillment_inventory vendor_direct_fulfillment_inventory_v1
    alias vendor_direct_fulfillment_orders vendor_direct_fulfillment_orders_2021_12_28
    alias vendor_direct_fulfillment_payments vendor_direct_fulfillment_payments_v1
    alias vendor_direct_fulfillment_sandbox_test_data vendor_direct_fulfillment_sandbox_test_data_2021_10_28
    alias vendor_direct_fulfillment_shipping vendor_direct_fulfillment_shipping_2021_12_28
    alias vendor_direct_fulfillment_transactions vendor_direct_fulfillment_transactions_2021_12_28
    alias vendor_invoices vendor_invoices_v1
    alias vendor_orders vendor_orders_v1
    alias vendor_shipments vendor_shipments_v1
    alias vendor_transaction_status vendor_transaction_status_v1
  end
end
