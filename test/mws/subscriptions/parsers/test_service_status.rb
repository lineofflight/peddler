...
class SubscriptionsServiceStatusParserTest < ParserTest
  def setup
    node = fixture('subscriptions/service_status').xpath('//xmlns:GetServiceStatusResult').first
    @service_status = MWS::Subscriptions::Parsers::ServiceStatus.new(node)
  end
